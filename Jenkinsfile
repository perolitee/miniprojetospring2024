...
//                     sh "mvn clean verify sonar:sonar -Dsonar.projectKey=miniprojetospring -Dsonar.host.url=http://192.168.0.2:9000 -Dsonar.login=sqp_3ceadd0b157eef45c001a8fe35a23d55d613f453"
        ...
        stage('SonarQube Analysis') {
            ...
            steps {
                ...
                sh "${env.SONAR_SCANNER_HOME}/bin/sonar-scanner -Dsonar.projectKey=miniprojetospring sonar.exclusions=**/*.java -Dsonar.host.url=http://192.168.0.2:9000 -Dsonar.login=sqp_3ceadd0b157eef45c001a8fe35a23d55d613f453"
